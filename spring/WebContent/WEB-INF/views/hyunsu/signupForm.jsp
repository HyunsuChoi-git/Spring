      ...
      <div class="col-md-6 mx-auto text-center">
         <div class="header-title">
            ...
            <h2 class="wv-heading--subtitle">
               follow me and we are going to the Hera World !!! 
            </h2>
         </div>
      </div>
      <div class="row">
         <div class="col-md-4 mx-auto">
            <div class="myform form ">
               <form action="signupPro.ss" method="post" name="login">
                  ...
                  <div class="form-group">
                     <input type="text" name="birth"  class="form-control my-input" id="birth" placeholder="Birthday">
                  </div>
                  <div class="form-group">
